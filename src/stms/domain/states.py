...
_TRANSITIONS: dict[RunState, tuple[Transition, ...]] = {
    ...
    RunState.REPLANNING: (Transition(AllowedEvent.FEEDBACK, RunState.INTERVIEWING, RunPhase.PLANNING), Transition(AllowedEvent.PAUSE, RunState.PAUSED, RunPhase.PLANNING)),
